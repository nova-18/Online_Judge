...
//       <div className="container mx-auto flex justify-center h-full pt-8">
//         <div className="w-full lg:w-4/5 xl:w-3/5 bg-gray-800 border border-gray-700 rounded-lg shadow-md">
//           <div className="flex h-full">
//             <LeftColumn />
//             <MiddleColumn setOutput={setOutput} />
//             <RightColumn output={output} />
//           </div>
//         </div>
//       </div>
//     </div>
